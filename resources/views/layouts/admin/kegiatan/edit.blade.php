                ...
                <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('kegiatan.update', $kegiatan->id) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="penanggungjawab" type="text" class="form-control @error('penanggungjawab') is-invalid @enderror" name="penanggungjawab" value="{{ $kegiatan->penanggungjawab }}" required autofocus>
