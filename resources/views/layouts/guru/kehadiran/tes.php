                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Data siswa {{ $keg->nama }}</h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="marginRight:0">Kehadiran</th>
                                    </tr>
                                </thead>
                                <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <div class="custom-control custom-control-alternative custom-checkbox">
                                                    <input class="custom-control-input" name="hadir[]" id="customCheckHadir{{ $value->id }}" type="checkbox" {{ old('hadir.' . $key) ? 'checked' : '' }} value="{{ $value->id }}" disabled>
